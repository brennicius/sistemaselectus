...
def estoque_pdv(pdv):
    ...
    if pdv == 'central' and not db.execute("SELECT 1 FROM estoque_revenda WHERE pdv='Central' LIMIT 1").fetchone():
        _seed = [
            ...
            ('Açaí', 'AÇAI COM GREGO'),
            ('Açaí', 'AÇAI COM MARACUJÁ'),
            ('Açaí', 'AÇAÍ COM CUPUAÇU'),
            ('Açaí', 'AÇAI COM BANANA'),
            ('Açaí', 'AÇAI COM MORANGO'),
            ('Barra de cereais', 'BARRA DE FRUTA NUTRY DE COCO'),
            ('Barra de cereais', 'BARRA DE FRUTA NUTRY DE BANANA COM CHOCOLATE'),
            ('Barra de cereais', 'BARRA DE CEREAL NUTRY BANANA E MEL'),
            ('Barra de cereais', 'BARRA DE CEREAL NUTRY AVELA'),
            ('Barra de cereais', 'BARRA DE CEREAL NUTRY BOLO DE CHOCOLATE'),
            ('Barra de cereais', 'BARRA DE CEREAL NUTRY MORANGO COM CHOCOLATE'),
            ('Barra de cereais', 'BARRA DE CEREAL NUTRY COCO COM CHOCOLATE'),
            ('Barra de cereais', 'BARRA DE CEREAL NUTRY CAPPUCCINO'),
            ('Barras Proteícas', 'PROTEIN CHOCOLATE 30G'),
            ('Barras Proteícas', 'PROTEIN COOKIES 30G'),
            ('Barras Proteícas', 'BARRA SUPINO PROTEIN CAPPUCCINO 30G'),
            ('Barras Proteícas', 'BARRA SUPINO PROTEIN CHOCOCOLATE 30G'),
            ('Barras Proteícas', 'BARRA SUPINO PROTEIN COCO 30G'),
            ('Bebidas proteícas', 'WHEYFIT ZERO CHOCOLATE 250ML'),
            ('Bebidas proteícas', 'NESCAFE PRO ENERGY'),
            ('Bebidas proteícas', 'WHEYFIT ZERO CAPPUCCINO 250ML'),
            ('Bebidas proteícas', 'WHEYFIT ZERO ABACATE 250ML'),
            ('Bebidas proteícas', 'WHEYFIT ZERO COCO COM BATATA 250ML'),
            ('Bebidas proteícas', 'WHEYFIT ZERO BAUNILHA 250ML'),
            ('Bebidas proteícas', 'YOPRO MORANGO 250ML'),
            ('Bebidas proteícas', 'YOPRO CHOCOLATE 250ML'),
            ('Bebidas proteícas', 'WHEYFIT ZERO MILHO VERDE 250ML'),
            ('Bebidas proteícas', 'PARMALAT MORANGO FIT 250ML'),
            ('Bebidas proteícas', 'PARMALAT CHOCOLATE FIT 23 GR 250ML'),
            ('Bebidas proteícas', 'WHEYFIT ZERO PISTACHE 250ML'),
            ('Bebidas proteícas', 'PARMALAT FIT MORANGO 100G'),
            ('Bebidas proteícas', 'YOPRO COC/BAT DOCE EDGE 250ML'),
            ('Bebidas proteícas', 'YOPRO CAPUCCINO 250ML'),
            ('Brownies', 'BROWNIE DOCE DE LEITE'),
            ('Brownies', 'BROWNIE NINHO'),
            ('Brownies', 'BROWNIE GANACHE'),
            ('Brownies', 'BROWNIE CHOCOLATE'),
            ('Brownies', 'BROWNIE - 80g'),
            ('Chás', 'CHA PRETO PESSEGO GOOD LIFE GARRAFA 270ML'),
            ('Chás', 'CHA PRETO LIMAO GOOD LIFE GARRAFA 270ML'),
            ('Chás', 'ICE TEA LEAO PESSEGO - 300ML'),
            ('Chás', 'ICE TEA LEAO LIMAO - 300ML'),
            ('Chás', 'CHA ICE TEA LEAO LIMAO ZERO 300 ML - 300ML'),
            ('Chás', 'CHA ICE TEA LEAO PESSEGO 250 ML - 250ML'),
            ('Chás', 'CHA ICE TEA LEAO PESSEGO ZERO 250 ML - 250ML'),
            ('Cuscuz', 'CUSCUZ'),
            ('Energéticos', 'GUARA MIX 290ML'),
            ('Energéticos', 'REDBULL'),
            ('Energéticos', 'ENERGETICO BALY CEREJA SEM AÇUCAR'),
            ('Energéticos', 'REDBULL ZERO'),
            ('Energéticos', 'BALY AMORA COM HORTELA SEM AÇUCAR 250ML'),
            ('Energéticos', 'BALY MELANCIA 250ML'),
            ('Energéticos', 'BALY MAÇA VERDE 250ML'),
            ('Energéticos', 'REDBULL MELANCIA'),
            ('Energéticos', 'BALY MAÇA VERDE SEM AÇUCAR 473ML'),
            ('Energéticos', 'BALY TRADICIONAL 250ML'),
            ('Energéticos', 'BALY TROPICAL 250ML'),
            ('Energéticos', 'BALY COCO E AÇAI 250ML'),
            ('Energéticos', 'BALY UVA VERDE 250ML'),
            ('Energéticos', 'REDBULL 355ML'),
            ('Energéticos', 'BALY MELANCIA ZERO 473ML'),
            ('Energéticos', 'BALY FLY NOW 250ML'),
            ('Energéticos', 'BALY MACA VERDE 250ML'),
            ('Frutas', 'MANGA EM PEDAÇOS'),
            ('Frutas', 'MIX DE FRUTAS UVA E MANGA'),
            ('Frutas', 'TANGERINA DESCASCADA'),
            ('Frutas', 'SALADA DE FRUTAS'),
            ('Frutas', 'MIX DE FRUTAS UVA E MELAO - 150G'),
            ('Frutas', 'SALADA DE FRUTAS - 180G'),
            ('Guloseimas', 'SONHO DE VALSA - 20g'),
            ('Guloseimas', 'OURO BRANCO - 20g'),
            ('Guloseimas', 'PAÇOQUITA'),
            ('Guloseimas', 'CHOKITO - 32G'),
            ('Guloseimas', 'CHOCOLATE TALENTO MEIO AMARGO AMENDOAS - 25G'),
            ('Guloseimas', 'CHOCOLATE CHARGE 40G'),
            ('Guloseimas', 'BIS XTRA ORIGINAL - 45g'),
            ('Guloseimas', 'CHOCOLATE TALENTO AVELAS 25g - 25G'),
            ('Guloseimas', 'JUJUBA'),
            ('Guloseimas', 'TALENTO CEREAIS E PASSAS - 25G'),
            ('Guloseimas', 'BATON - 16g'),
            ('Guloseimas', 'CHOCOLATE TALENTO AMENDOAS E PASSAS - 25G'),
            ('Guloseimas', 'PRESTIGIO'),
            ('Guloseimas', 'MINI OREO'),
            ('Guloseimas', 'KITKAT WHITE'),
            ('Guloseimas', 'CHOCOLATE LOLLO 28G'),
            ('Guloseimas', 'CHOCOLATE TALENTO CASTANHA DO PARA - 25G'),
            ('Guloseimas', 'CHOCOLATE TALENTO AVELAS DIET 25g'),
            ('Guloseimas', 'KITKAT'),
            ('Guloseimas', 'KITKAT DARK'),
            ('Guloseimas', 'MMS AMENDOIM 40G'),
            ('Guloseimas', 'PRESTIGIO DARK'),
            ('Guloseimas', 'PE DE MOÇA'),
            ('Guloseimas', 'BEIJO DE LEITE'),
            ('Guloseimas', 'BRIGADEIRO DOCES VIEIRA'),
            ('Guloseimas', 'COCADA BAIANA DOCES VIEIRA'),
            ('Guloseimas', 'BATON EXTRA MILK'),
            ('Guloseimas', 'MMS CHOCOLATE 40G'),
            ('Guloseimas', 'PAÇOQUITA DIET'),
            ('Guloseimas', 'TRENTO CHOCOLATE'),
            ('Guloseimas', 'PRESTIGIO BRANCO'),
            ('Guloseimas', 'CHOCOLATE BRANCO LAKA 28G'),
            ('Guloseimas', 'TRIDENT HORTELA 8G'),
            ('Guloseimas', 'JUJUBA IOGURTE'),
            ('Guloseimas', 'PIPOCA DOCE OK CHIPS'),
            ('Guloseimas', 'TRIDENT MENTA 8G'),
            ('Guloseimas', 'TRENTO MASSIMO CHOCOLATE'),
            ('Guloseimas', 'NUTELLA B READY'),
            ('Guloseimas', 'CHOCOLATE LACTA AO LEITE 28G'),
            ('Guloseimas', 'HALLS EXTRA FORTE'),
            ('Guloseimas', 'BISCOITO OREO - 36G'),
            ('Guloseimas', 'HALLS CEREJA'),
            ('Guloseimas', 'TRENTO AVELÃ'),
            ('Guloseimas', 'BATON DUO'),
            ('Guloseimas', 'TRENTO DUO'),
            ('Guloseimas', 'DIAMANTE NEGRO 28G'),
            ('Guloseimas', 'ESCURETO 35,6G'),
            ('Guloseimas', 'SNICKERS'),
            ('Guloseimas', 'TORCIDA PIMENTA MEXICANA - 35G'),
            ('Guloseimas', 'BATON CREME'),
            ('Guloseimas', 'AMENDOIM HELENA MENDORATO'),
            ('Guloseimas', 'FINI BEIJOS 15G'),
            ('Guloseimas', 'SNICKERS BRANCO'),
            ('Guloseimas', 'TORCIDA QUEIJO - 35G'),
            ('Guloseimas', 'FINI BANANAS 15G'),
            ('Guloseimas', 'TRENTO BRANCO DARK 29G'),
            ('Guloseimas', 'FINI BEIJOS 80G'),
            ('Guloseimas', 'SNICKERS DARK'),
            ('Guloseimas', 'TRENTO MASSIMO DARK'),
            ('Guloseimas', 'TRIDENT X SENSES MENTA 54G'),
            ('Guloseimas', 'TRIDENT X SENSES HORTELA 54G'),
            ('Guloseimas', 'FINI MINHOCAS 15G'),
            ('Guloseimas', 'BEIJO DE MOÇA DOCES VIEIRA'),
            ('Guloseimas', 'TRENTO WAFER DARK'),
            ('Guloseimas', 'BARRINHA BAUDUCCO CHOCOLATE'),
            ('Guloseimas', 'PETTIZ AMENDOIM CROCANTE 120G'),
            ('Guloseimas', 'BANANINHA PALMITAL TRADICIONAL'),
            ('Guloseimas', 'BARRINHA GOIABA BAUDUCCO - 30g'),
            ('Guloseimas', 'FINI BANANAS 80G'),
            ('Guloseimas', 'JUJUBA IOGURTE GOMUTCHO'),
            ('Guloseimas', 'TRENTO TORTA DE LIMÃO'),
            ('Guloseimas', 'PAÇOQUITA ZERO COM AVEIA'),
            ('Guloseimas', 'TRENTO MASSIMO BRANCO COM COOKIES'),
            ('Guloseimas', 'TRENTO MASSIMO NUTS'),
            ('Guloseimas', 'BATON BRANCO'),
            ('Guloseimas', 'PIPOCA DOCE OK 90G'),
            ('Guloseimas', 'TUBIN AVELA'),
            ('Guloseimas', 'CHOCOLATE AO LEITE'),
            ('Guloseimas', 'TRENTO CHOCOLATE PECCIN 29G'),
            ('Guloseimas', 'AMENDOIM MENDORATO 70G'),
            ('Guloseimas', 'BISCOITO CREAM CRACKER'),
            ('Guloseimas', 'SNICKERS DUPLO CHOCOLATE'),
            ('Guloseimas', 'PRESTIGIO DOCE DE LEITE'),
            ('Guloseimas', 'COOKIES CHOCOLATE BAUDUCCO 60g - 60G'),
            ('Guloseimas', 'CHOCOLATE TALENTO AVELAS 85G'),
            ('Guloseimas', 'PIPOCA MAGRELA DOCE MELADO'),
            ('Guloseimas', 'SNICKERS PE DE MOLEQUE'),
            ('Iogurte', 'DANONE GREGO TRADICIONAL 90G'),
            ('Iogurte', 'DANONE GREGO FRUTAS VERMELHAS - 90G'),
            ('Iogurte', 'IOGURTE GREGO MORANGO PENSE Z 100G'),
            ('Iogurte', 'IOGURTE NATURAL DANONE INTEGRAL 160G'),
            ('Iogurte', 'DANONE LÍQUIDO VITAMINAS DE FRUTAS 170G'),
            ('Iogurte', 'IOGURTE LIQUIDO DANONE MORANGO'),
            ('Iogurte', 'IOGURTE GREGO TRADICIONAL PENSE Z 100G'),
            ('Iogurte', 'IOGURTE GREGO MARACUJA PENSE Z 100G'),
            ('Iogurte', 'IOGURTE DESNATADO'),
            ('Iogurte', 'ACTIVIA CAFE DA MANHA AMARANTO E MAMAO 170G'),
            ('Iogurte', 'ITAMBÉ GREGO TRADICIONAL 90g'),
            ('Iogurte', 'SOBREMESA CHOCOLATE COM CHANTILLY ITAMBE 100G'),
            ('Iogurte', 'IOGURTE PARCIALMENTE DESNATADO MORANGO 170G'),
            ('Iogurte', 'ACTIVIA CAFE DA MANHA QUINOA 170G'),
            ('Iogurte', 'ACTIVIA CAFE DA MANHA LINHAÇA 170G'),
            ('Iogurte', 'BATAVO NATURAL DESNATADO 150G'),
            ('Iogurte', 'IOGURTE MORANGO DANONINHO 100G'),
            ('Iogurte', 'NATURAL MILK INTEGRAL 170g'),
            ('Iogurte', 'IOGURTE DESNATADO ITAMBE 170G'),
            ('Iogurte', 'IOGURTE ITAMBE NATURAL INTEGRAL 170G'),
            ('Iogurte', 'IOGURTE ITAMBE VITAMINA COM CEREAL 170G'),
            ('Iogurte', 'IOGURTE GREGO MORANGO BATAVO 100G'),
            ('Iogurte', 'IOGURTE FRUTAS VERMELHAS ITAMBE 170G'),
            ('Iogurte', 'BATAVO NATURAL INTEGRAL 160G'),
            ('Iogurte', 'PUDIM BATAVO 100G'),
            ('Iogurte', 'IOGURTE BATAVO GREGO TRADICIONAL 100G'),
            ('Iogurte', 'IOGURTE CENOURA LARANJA E MEL 170G'),
            ('Iogurte', 'LEITE FERMENTADO ITAMBE ZERO LACTOSE'),
            ('Iogurte', 'IOGURTE NESTLE MORANGO'),
            ('Iogurte', 'IOGURTE NATURAL MILK INTEGRAL COPO 170G'),
            ('Iogurte', 'IOGURTE LIQUIDO ACTIVIA MORANGO GARRAFA 150G'),
            ('Iogurte', 'IOGURTE PARCIALMENTE DESNATADO BANANA MACA E CEREAL 170G'),
            ('Iogurte', 'PUDIM DE LEITE ITAMBE 100G'),
            ('Iogurte', 'IOGURTE DESNATADO COCO ZERO LACTOSE 220G'),
            ('Iogurte', 'IOGURTE LIQUIDO MORANGO ITAMBE 170G'),
            ('Iogurte', 'IOGURTE LIQUIDO ACTIVIA AMEIXA GARRAFA 150G'),
            ('Iogurte', 'BATAVO NATURAL DESNATADO 160G'),
            ('Iogurte', 'IOGURTE CENOURA LARANJA E MEL 160G'),
            ('Iogurte', 'IOGURTE BATAVO MORANGO 170G'),
            ('Iogurte', 'ITAMBÉ GREGO MORANGO 90g'),
            ('Iogurte', 'IOGURTE DESNATADO BATAVO PENSE ZERO 100g'),
            ('Iogurte', 'IOGURTE GREGO TRADICIONAL 450G'),
            ('Iogurte', 'IOGURTE BATAVO BANANA MAÇA E CEREAL 170G'),
            ('Iogurte', 'DANONE GREGO INTEGRAL'),
            ('Iogurte', 'NESTLE VITAMINA DE FRUTAS 170G'),
            ('Iogurte', 'IOGURTE BATIDO E AVEIA'),
            ('Iogurte', 'IOGURTE ITAMBÉ LÍQUIDO VITAMINA C/CEREAL 170g'),
            ('Líquidos', 'NESCAU 180ML'),
            ('Líquidos', 'DAMARE KIDS CHOCOLATE 200ML'),
            ('Pratos', 'FRANGO SICILIANO 350G MNA'),
            ('Pratos', 'STROGONOFF DE CARNE 450g MNA'),
            ('Pratos', 'PENNE A BOLONHESA 400g MNA'),
            ('Pratos', 'PARMEGIANA DE FRANGO COM SPAGHET NA MANTEIGA KTM'),
            ('Pratos', 'STROGONOFF DE FRANGO 450g MNA'),
            ('Pratos', 'FILE DE FRANGO COM LEGUMES 340g MNA'),
            ('Pratos', 'PATINHO FIT 350G MNA'),
            ('Pratos', 'ESCONDIDINHO DE FRANGO 400g MNA'),
            ('Pratos', 'PERNIL SUÍNO AO MOLHO BARBECUE DA CASA BATATA DO REINO E ARROZ INTEGRAL KTM'),
            ('Pratos', 'CARNE DE PANELA COM BATATA DOCE E ARROZ INTEGRAL KTM'),
            ('Pratos', 'FRANGO CASEIRO 350g MNA'),
            ('Pratos', 'ESCONDIDINHO MAROMBA DE FRANGO KTM'),
            ('Pratos', 'FEIJOADA 450G MNA'),
            ('Pratos', 'PATINHO COM ARROZ E FEIJAO 350G MNA'),
            ('Pratos', 'CARNE DESFIADA COM LEGUMES AO MOLHO MADEIRA, AIPIM COZIDO COM MANTEIGA KTM'),
            ('Pratos', 'FRANGO GUADALAJARA, ACOMPANHADO DE BATATA DO REINO E ARROZ INTEGRAL KTM'),
            ('Pratos', 'PEITO DE FRANGO NA CHAPA, EM CROSTA DE TAPIOCA, ACOMPANHADO DE PURÊ DE BANANA DA TERRA E ARROZ INTEGRAL KTM'),
            ('Pratos', 'NHOQUE DE BATATA - 300G'),
            ('Pratos', 'FILEZINHO DE FRANGO AO MOLHO FERRUGEM, ACOMPANHADO DE ARROZ INTEGRAL KTM'),
            ('Pratos', 'CORTADINHO DE CARNES COM LEGUMES, ACOMPANHADO DE ARROZ MINI ALMONDEGAS DE LEGUMES KTM'),
            ('Pratos', 'MINI POLPETONE DE CARNE - 300G'),
            ('Pratos', 'FILE DE FRANGO AO MOLHO PESTO DE MANJERICAO COM LINHAÇA KTM'),
            ('Pratos', 'PALETA BOVINA COZIDA E ASSADA COM LEGUMES, ACOMPANHADA DE ARROZ ORIENTAL E TUTU DE FEIJÃO KTM'),
            ('Pratos', 'STROGONOFF DE CARNE, ARROZ BRANCO E BATATA ASSADA CUBOS - 300g'),
            ('Pratos', 'LASANHA BOLONHESA 300G'),
            ('Pratos', 'ASSADO DE BOI, ACOMPANHADO DE MIX DE LEGUMES AO FORNO KTM'),
            ('Pratos', 'KAFTA DE FRANGO FIT, COM ABOBORA ASSADA - 300G'),
            ('Pratos', 'ST PETER AO CREME DE COCO - 300G'),
            ('Pratos', 'ESCONDIDINHO MAROMBA DE FRANGO, ACOMPANHADO DE MIX DE LEGUMES ASSADOS KTM'),
            ('Pratos', 'FRANGO DESFIADO - 300G'),
            ('Pratos', 'PICADINHO DE CARNE - 300G'),
            ('Pratos', 'PANQUECA DE FRANGO - 300G'),
            ('Pratos', 'LASANHA PESTO 300G'),
            ('Pratos', 'FEIJOADA LIGHT - 300G'),
            ('Pratos', 'MASSA ITALIANA A BOLANHESA 300G'),
            ('Pratos', 'TIRAS DE FRANGO GRELHADAS LIGHT - 300G'),
            ('Pratos', 'ISCAS DE FILET A PARMEGIANA - 300g'),
            ('Pratos', 'FILE A PARMEGIANA 400G'),
            ('Pratos', 'LADO A LADO (CARNE COZIDA E AIPIM), ACOMPANHADO DE ARROZ INTEGRAL KTM'),
            ('Pratos', 'PALETA BOVINA DESFIADA COM VAGEM KTM'),
            ('Pratos', 'POLPETTINE COM PURÊ DE BATATA 300G'),
            ('Pratos', 'LASANHA POLLO SPINAFRE 300G'),
            ('Pratos', 'PARMEGIANA DE FRANGO - 400g MNA'),
            ('Pratos', 'SPAGHETTI DE ABOBRINHA VEGGIE LIGHT AO POMODORO - 300g'),
            ('Pratos', 'FRANGO THAI - 300g'),
            ('Pratos', 'PANQUECA DE BRÓCOLIS E COUVE-FLOR AO MOLHO DE QUEIJO KTM'),
            ('Pratos', 'LADO A LADO (CARNE COZIDA E AIPIM), ACOMPANHADO DE ARROZ INTEGRAL'),
            ('Pratos', 'RAGU DE CARNE'),
            ('Pratos', 'FRANGO XADREZ 350g MNA'),
            ('Pratos', 'ISCAS DE FRANGO A PARMEGIANA - 300g'),
            ('Pratos', 'TORTA DE PEIXE COM DE PURÊ DE BATATA DOCE KTM'),
            ('Pratos', 'CARNE SECA COM PURE DE ABOBORA - 300G'),
            ('Pratos', 'ESCALOPE AO CAPIM SANTO 310g MNA'),
            ('Pratos', 'RONDELI DE QUEIJO AO MOLHO ROSE - 300G'),
            ('Pratos', 'ESCONDIDIM CHARQUE 400G'),
            ('Pratos', 'PENNE A BOLONHESA 300G'),
            ('Pratos', 'BOBÓ DE FRANGO, ACOMPANHADO DE ARROZ INTEGRAL COM LEGUMES KTM'),
            ('Pratos', 'ESCONDIDINHO DE CARNES KTM'),
            ('Pratos', 'QUICHE DE FRANGO COM ARROZ KTM'),
            ('Pratos', 'FEIJOADA CARIOCA'),
            ('Pratos', 'LINGUINI COM TIRAS DE PEITO DE FRANGO 300G'),
            ('Pratos', 'PENNE A BOLONHESA 400g'),
            ('Pratos', 'RAVIOLI DE MOZZARELA AO MOLHO SUGO - 300G'),
            ('Pratos', 'ESCONDIDIM FRANGO 400G'),
            ('Pratos', 'PARMEGGIANA DE FRANGO'),
            ('Pratos', 'CORTES DE FRANGO AO MOLHO DE LARANJA 400G KTM'),
            ('Pratos', 'FILE DE COXA DE FRANGO AO MOLHO DE CERVEJA'),
            ('Pratos', 'STROGONOFFINHO DE FRANGO - 300G'),
            ('Pratos', 'ESCONDIDINHO DE FRANGO 400g'),
            ('Pratos', 'FEIJOADA CARIOCA 400G'),
            ('Pratos', 'FRANGO XADREZ COM BATATA DO REINO KTM'),
            ('Pratos', 'RAGU DE CARNE - 300G'),
            ('Pratos', 'FILE DE FRANGO COM LEGUMES 340g'),
            ('Pratos', 'TILAPIA GRELHADA AO MOLHO DE MARACUJA YOU'),
            ('Pratos', 'FRANGO DESOSSADO ASSADO YOU'),
            ('Pratos', 'FRICASSÈ DE FRANGO, ACOMPANHADO DE ARROZ INTEGRAL COLORIDO KTM'),
            ('Pratos', 'LASANHA PESTO 300G ING'),
            ('Pratos', 'NHOQUE DE ESPINAFRE E RICOTA'),
            ('Pratos', 'NHOQUE DE ESPINAFRE E RICOTA - 300G'),
            ('Pratos', 'PATINHO COM ARROZ E FEIJAO 350G'),
            ('Pratos', 'PATINHO FIT 350G'),
            ('Pratos', 'PEITO DE FRANGO GRELHADO COM LEGUMES YOU'),
            ('Pratos', 'ESCONDIDINHO DE CARNE MOIDA E ABOBORA YOU'),
            ('Pratos', 'LASANHA DE FRANGO'),
            ('Pratos', 'LASANHA ESPECIAL DE FRANGO 400G'),
            ('Pratos', 'MRT - PARMEGIANA DE FRANGO - 400g'),
            ('Pratos', 'STROGONOFF DE FRANGO, ARROZ BRANCO, BATATA CUBOS ASSADA'),
            ('Pratos', 'CANJA - 400g'),
            ('Pratos', 'PERNIL SUÍNO AO MOLHO MADEIRA COM PASSAS KTM'),
            ('Pratos', 'CREME DE MACAXEIRA C/ CHARQUE - 400g'),
            ('Pratos', 'ESCALOPINHO DE CARNE COM ABOBORA KTM'),
            ('Pratos', 'ESCONDIDIM COSTELA 400G'),
            ('Pratos', 'FRICASSE DE FRANGO 300g MNA'),
            ('Pratos', 'OMELETE DE LEGUMES COM RICOTA KTM'),
            ('Pratos', 'PANQUECA DE AVEIA E FRANGO YOU'),
            ('Pratos', 'QUIABADA NORDESTINA, ACOMPANHADA DE ARROZ INTEGRAL COLORIDO E FEIJÃO CASEIRO KTM'),
            ('Pratos', 'TORTA DE BANANA DA TERRA, ACOMPANHADA DE MIX LEGUMES KTM'),
            ('Pratos', 'SOPA DE CARNE - 400g'),
            ('Pratos', 'STROGONOFFINHO DE CARNE'),
            ('Pratos', 'TRIGOSTOSO DE FRANGO'),
            ('Pratos', 'PENNE AO MOLHO PESTO DE MANJERICÃO C/ CASTANHAS (VEGETARIANO)'),
            ('Pratos', 'RAVIOLI DE CARNE AO MOLHO SUGO - 300g'),
            ('Pratos', 'ROLINHOS DE FRANGO AO AÇAFRÃO RECHEADOS COM LEGUMES KTM'),
            ('Pratos', 'CARNE DO SOL COM PURE DE AIPIM KTM'),
            ('Pratos', 'MIGNON AO MOLHO MADEIRA - 350g MNA'),
            ('Pratos', 'PEITO DE FRANGO AO MOLHO PESTO DE TOMATES COM CASTANHAS KTM'),
            ('Pratos', 'POLPETONES DE CARNE AO SUGO KTM'),
            ('Pratos', 'QUICHE DE CARNES 400G'),
            ('Pratos', 'FILÉ DE FRANGO AO MOLHO 3 QUEIJOS KTM'),
            ('Pratos', 'ROCAMBOLE DE PEIXE, AOCMPANHADO DE ARROZ INTEGRAL COM COUVE KTM'),
            ('Pratos', 'STROGONOFF DE FRANGO 450g'),
            ('Pratos', 'STROGONOFFINHO DE CARNE - 300G'),
            ('Pratos', 'CAPONATA VEGGIE - 300G'),
            ('Pratos', 'ESCABECHE DE MERLUZA KTM'),
            ('Pratos', 'FIGADO AO MOLHO DE TOMATES, ACOMPANHADO DE ARROZ INTEGRAL COM LEGUMES KTM'),
            ('Pratos', 'FILÉ DE FRANGO AO MOLHO MADEIRA COM PURE KTM'),
            ('Pratos', 'FRANGO TROPICAL, ACOMPANHADO DE ARROZ INTEGRAL E GRÃO DE BICO KTM'),
            ('Pratos', 'LINGUINNI A BOLOGNESA'),
            ('Pratos', 'MRT - PARMEGIANA DE CARNE - 400g'),
            ('Pratos', 'PARMEGIANA DE CARNE - 400g MNA'),
            ('Pratos', 'PENNE A BOLONHESA 300GR'),
            ('Pratos', 'STROGONOFF DE CARNE 450g'),
            ('Pratos', 'BATATA RECHEADA CARNE + PROTEÍNA'),
            ('Pratos', 'CALDO VERDE - 400g'),
            ('Pratos', 'COMIDA BAIANA COMPLETA COM XIMXIM DE GALINHA'),
            ('Pratos', 'CORTADINHO DE CARNE COM LEGUMES KTM'),
            ('Pratos', 'FEIJOADA 450G'),
            ('Pratos', 'FILÉ DE PEITO DE FRANGO EMPANADO COM ESPINAFRE KTM'),
            ('Pratos', 'FRANGUINHO DESFIADO'),
            ('Pratos', 'MINI PENNE COM ALMONDEGAS AO SUGO - 300G'),
            ('Pratos', 'MRT - MIGNON AO MOLHO MADEIRA - 350g'),
            ('Pratos', 'OMELETE DE FRANGO COM LEGUMES KTM'),
            ('Pratos', 'PENNE AO QUATRO QUEIJOS 300G'),
            ('Pratos', 'QUICHE DE MILHO VERDE COM CREME DE RICOTA, ACOMPANHADO DE BRÓCOLIS KTM'),
            ('Pratos especiais', 'BOBO DE CAMARAO 400g MNA'),
            ('Pratos especiais', 'GUISADINHO DE CARNE 450g MNA'),
            ('Pratos especiais', 'SALMAO AO MARACUJA 350g MNA'),
            ('Pratos especiais', 'ESCONDIDINHO DE CARNE DE SOL 400G MNA'),
            ('Pratos especiais', 'ESCONDIDINHO DE CHARQUE 450g MNA'),
            ('Pratos especiais', 'RISOTO DE SALMAO 350g MNA'),
            ('Pratos especiais', 'CAMARAO PRIMAVERA 350g MNA'),
            ('Pratos especiais', 'PENNE QUATRO QUEIJOS 350g MNA'),
            ('Refrigerantes', 'COCA COLA ZERO PET 200ML'),
            ('Refrigerantes', 'COCA COLA PET 200ML'),
            ('Refrigerantes', 'GUARANA ANTARCTICA ZERO PET - 200ML'),
            ('Refrigerantes', 'PEPSI BLACK PET 200ML'),
            ('Refrigerantes', 'GUARANA ANTARCTICA PET - 200ML'),
            ('Refrigerantes', 'GUARANA ANTARCTICA DIET LATA - 350ML'),
            ('Refrigerantes', 'COCA COLA LATA - 220ML'),
            ('Refrigerantes', 'GUARANA ANTARCTICA LATA - 350ML'),
            ('Refrigerantes', 'FANTA LARANJA GARRAFA 200ML'),
            ('Refrigerantes', 'COCA COLA ZERO - 220ML'),
            ('Refrigerantes', 'COCA COLA ZERO LATA - 350ML'),
            ('Refrigerantes', 'FANTA LARANJA 350ML'),
            ('Refrigerantes', 'COCA COLA LATA 350ML'),
            ('Refrigerantes', 'FANTA LARANJA 220ml LATA - 220ML'),
            ('Refrigerantes', 'COCA COLA LATA - 350ML'),
            ('Refrigerantes', 'COCA COLA ZERO GARRAFA 250ml'),
            ('Refrigerantes', 'COCA COLA - 200ML'),
            ('Refrigerantes', 'COCA COLA GARRAFA - 250ML'),
            ('Refrigerantes', 'PEPSI BLACK PET 200M'),
            ('Refrigerantes', 'SPRITE 220ML'),
            ('Sucos', 'SUCO UVA E MAÇÃ NATURAL ONE - 180ML'),
            ('Sucos', 'SUCO LARANJA E MAÇÃ NATURAL ONE - 180ML'),
            ('Sucos', 'SUCO DE MAÇA YAKULT 200ML'),
            ('Sucos', 'NATURAL ONE MAÇA - 180ML'),
            ('Sucos', 'SUCO DOCE MEL MARACUJA 200ML'),
            ('Sucos', 'SUCO LARANJA MARATA 200ML'),
            ('Sucos', 'SUCO UVA MARATA 200ML'),
            ('Sucos', 'SUCO DOCE MEL GOIABA 200ML'),
            ('Sucos', 'SUCO DOCE MEL ACEROLA 200ML'),
            ('Sucos', 'SUCO PESSEGO MARATA 200ML'),
            ('Sucos', 'SUCO GOIABA MARATA 200ML'),
            ('Sucos', 'SUCO DOCE MEL CAJU 200ML'),
            ('Sucos', 'SUCO NATURAL ONE AMBIENTE 900ML'),
            ('Sucos', 'SUCO TANGERINA MARATA 200ML'),
            ('Água', 'AGUA MINERAL PETROPOLIS COM GAS 500ML'),
            ('Água', 'AGUA MINERAL INDAIA 330ml - 330ml'),
            ('Água', 'AGUA MINERAL SCHIN 500ML'),
        ]
